...
customer_trusted_node1706216815753 = glueContext.create_dynamic_frame.from_options(
    format_options={"multiline": False},
    connection_type="s3",
    format="json",
    connection_options={"paths": ["s3://borti-stedi/customer/trusted/"]},
    transformation_ctx="customer_trusted_node1706216815753",
)
...
SQLQuery_node1706216830327 = sparkSqlQuery(
    ...
    query=SqlQuery0,
    mapping={
        "cus": customer_trusted_node1706216815753,
...
AmazonS3_node1705660470302 = glueContext.getSink(
    path="s3://borti-stedi/customer/curated/",
    connection_type="s3",
    updateBehavior="LOG",
    partitionKeys=[],
